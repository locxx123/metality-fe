    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-accent/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="p-6 shadow-lg border-0 bg-white dark:bg-card">
          <div className="mb-6">
            <h2 className="text-2xl text-center font-bold text-foreground">Đăng nhập</h2>
            <p className="text-sm text-center text-muted-foreground mt-1">Chào mừng bạn trở lại</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <div className="flex gap-2">
              <Button 
                variant="outline" 
                className="flex-1 cursor-pointer bg-transparent hover:bg-[#666]  dark:hover:bg-gray-800"
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          Chưa có tài khoản?{" "}
          <Link to={ROUTE_URL.SIGNUP} className="text-primary hover:underline font-medium">
            Đăng ký ngay
          </Link>
        </p>
      </div>
